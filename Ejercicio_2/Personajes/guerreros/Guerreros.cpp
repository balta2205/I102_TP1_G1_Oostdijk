...
Guerreros::Guerreros(int vida, int defensa_fisica, int defensa_magica, int nivel, int stamina, std::pair<std::shared_ptr<Arma>, std::shared_ptr<Arma>> armas)
    : vida(vida), defensa_fisica(defensa_fisica), defensa_magica(defensa_magica), nivel(nivel), stamina(stamina), armas(armas) {}
...
std::pair<std::shared_ptr<Arma>, std::shared_ptr<Arma>> Guerreros::get_armas() {return this->armas;}
