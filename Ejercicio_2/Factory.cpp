...
std::shared_ptr<Arma> PersonajeFactory::crearArma(Armas_lista arma){ 
    switch (arma) {
        ...
        case Armas_lista::BASTON : return std::make_shared<Baston>(25, 5, 100, 15, 0);
        case Armas_lista::LIBROHECHIZO : return std::make_shared<Libro_Hechizos>(85, 10, 100, 20, 5);
        case Armas_lista::POCION : return std::make_shared<Pociones>(15, 5, 100, 15, 3);
        case Armas_lista::AMULETO : return std::make_shared<Amuletos>(20, 8, 100, 10, 7);
        case Armas_lista::HACHA_S : return std::make_shared<Hacha_simple>(30, 7, 100, 18, 13, 5);
        case Armas_lista::HACHA_D : return std::make_shared<Hacha_doble>(40, 10, 100, 25, 15, 5);
        case Armas_lista::ESPADA : return std::make_shared<Espada>(35, 8, 100, 20, 5, 7);
        case Armas_lista::LANZA : return std::make_shared<Lanza>(25, 6, 100, 15, 15, 10);
        case Armas_lista::GARROTE : return std::make_shared<Garrote>(20, 7, 100, 18, 10, 5);
